...
function PlayState:update(dt)
    ...
    if self.ball.inPlay then
        self.ball:update(dt)
    end

    --ADDED

   if self.ball2.inPlay then
    ...
    if self.ball2:collides(self.paddle) then
        self.ball2:paddleHit(self.paddle)
    ...
    for k, brick in pairs(self.bricks) do
        ...
        if brick.inPlay and self.ball:collides(brick) then
            ...
            --ADDED - activate powerUp
            if self.powerUp.trigger == 5 then
                self.powerUp.inPlay = true
            end
            self.powerUp.trigger = self.powerUp.trigger + 1
    ...
    if self.ball.inPlay == false and self.ball2.inPlay == false then
