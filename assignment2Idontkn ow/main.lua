...
function love.load()
    ...
    --CHANGED - to support updated Love (added  'static' to each)
    gSounds = {
...
function love.draw()
    ...
    love.graphics.draw(gTextures['main'], gFrames['power'][3], 20, 60, 0, 2, 2)
    love.graphics.draw(gTextures['main'], gFrames['power'][4], 20, 80, 0, 2, 2)

    love.graphics.draw(gTextures['main'], gFrames['power'][5], 20, 100, 0, 2, 2)
    love.graphics.draw(gTextures['main'], gFrames['power'][6], 20, 120, 0, 2, 2)
    love.graphics.draw(gTextures['main'], gFrames['power'][7], 20, 140, 0, 2, 2)
...
function loadHighScores()
    ...
    --CHANGED - to support updated Love
